import pytest
from src.utils import greetings, data_from_excel, cards_data, sort_by_payment, currency_rates, stock_information
...
def test_sort_by_payment(test_excel_file_2):
    ...
    assert result == [{'date': '22.07.2019', 'amount': -5000.0, 'category': 'Наличные', 'description': 'Снятие в банкомате Сбербанк'}, {'date': '22.07.2019', 'amount': -5000.0, 'category': 'Супермаркеты', 'description': 'Снятие в банкомате Сбербанк'}, {'date': '22.07.2019', 'amount': -3000.0, 'category': 'Супермаркеты', 'description': 'Лента'}, {'date': '22.07.2019', 'amount': -2000.0, 'category': 'Наличные', 'description': 'Снятие в банкомате Сбербанк'}, {'date': '22.07.2019', 'amount': -1000.0, 'category': 'Наличные', 'description': 'Снятие в банкомате Сбербанк'}]
